...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnStartGameButtonClicked()
    {
        ...
        {
            if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("rc")) // racing gamemode
            {
                PhotonNetwork.LoadLevel("RacingScene");
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("dr")) // deathrace gamemode
            {
